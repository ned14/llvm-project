...
///
/// \file
/// Internal header for the WG14 N3924 signal_decider_create entrypoint
/// (implemented by the wg14_signals reference implementation submodule,
/// libc/src/signal/wg14).
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIBC_SRC_SIGNAL_SIGNAL_DECIDER_CREATE_H
#define LLVM_LIBC_SRC_SIGNAL_SIGNAL_DECIDER_CREATE_H
...
#endif // LLVM_LIBC_SRC_SIGNAL_SIGNAL_DECIDER_CREATE_H
