...
///
/// \file
/// Internal header for the WG14 N3924 sigdecider_abandon entrypoint
/// (implemented by the wg14_signals reference implementation submodule,
/// libc/src/signal/wg14).
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIBC_SRC_SIGNAL_SIGDECIDER_ABANDON_H
#define LLVM_LIBC_SRC_SIGNAL_SIGDECIDER_ABANDON_H
...
#endif // LLVM_LIBC_SRC_SIGNAL_SIGDECIDER_ABANDON_H
