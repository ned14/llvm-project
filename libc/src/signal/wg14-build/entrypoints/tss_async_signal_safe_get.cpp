//===-- WG14 N3924 tss_async_signal_safe_get entrypoint wrapper
//-----------------*- C++ -*-===//
//
...
void *wg14_signals_tss_async_signal_safe_get(tss_async_signal_safe_t val);
}

namespace LIBC_NAMESPACE_DECL {

LLVM_LIBC_FUNCTION(void *, tss_async_signal_safe_get,
                   (tss_async_signal_safe_t val)) {
  return wg14_signals_tss_async_signal_safe_get(val);
}
