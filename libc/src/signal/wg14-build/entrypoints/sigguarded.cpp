//===-- WG14 N3924 sigguarded entrypoint wrapper -----------------*- C++
//-*-===//
//
...
extern "C"
{
  ...
  wg14_signals_sigguarded(const sigset_t *signals, sig_func_t guarded,
                          sig_recover_t recovery, sig_decide_t decider,
...
namespace LIBC_NAMESPACE_DECL
{
  ...
  LLVM_LIBC_FUNCTION(union stdc_siginfo_value, sigguarded,
                     (const sigset_t *signals, sig_func_t guarded,
                      sig_recover_t recovery, sig_decide_t decider,
                      union stdc_siginfo_value value))
  {
    return wg14_signals_sigguarded(signals, guarded, recovery, decider, value);
  }
