//===-- WG14 N3924 tss_async_signal_safe_destroy entrypoint wrapper
//-----------------*- C++ -*-===//
//
...
int wg14_signals_tss_async_signal_safe_destroy(tss_async_signal_safe_t val);
}

namespace LIBC_NAMESPACE_DECL {

LLVM_LIBC_FUNCTION(int, tss_async_signal_safe_destroy,
                   (tss_async_signal_safe_t val)) {
  return wg14_signals_tss_async_signal_safe_destroy(val);
}
