//===-- WG14 N3924 sigdecider_abandon entrypoint wrapper -----------------*- C++
//-*-===//
//
...
#include "src/signal/sigdecider_abandon.h"
...
extern "C"
{
  ...
  void wg14_signals_sigdecider_abandon(struct stdc_siginfo *rsi);
}

namespace LIBC_NAMESPACE_DECL
{

  LLVM_LIBC_FUNCTION(void, sigdecider_abandon, (struct stdc_siginfo * rsi))
  {
    return wg14_signals_sigdecider_abandon(rsi);
  }
