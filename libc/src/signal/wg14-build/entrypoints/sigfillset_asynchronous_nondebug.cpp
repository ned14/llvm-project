//===-- WG14 N3924 sigfillset_asynchronous_nondebug entrypoint wrapper
//-----------------*- C++ -*-===//
//
...
extern "C"
{
  ...
  int wg14_signals_sigfillset_asynchronous_nondebug(sigset_t *set);
}

namespace LIBC_NAMESPACE_DECL
{

  LLVM_LIBC_FUNCTION(int, sigfillset_asynchronous_nondebug, (sigset_t * set))
  {
    return wg14_signals_sigfillset_asynchronous_nondebug(set);
  }
