//===-- WG14 N3924 tss_async_signal_safe_create entrypoint wrapper
//-----------------*- C++ -*-===//
//
...
int wg14_signals_tss_async_signal_safe_create(
...
LLVM_LIBC_FUNCTION(int, tss_async_signal_safe_create,
                   (tss_async_signal_safe_t * val,
                    const struct tss_async_signal_safe_attr *attr)) {
  return wg14_signals_tss_async_signal_safe_create(val, attr);
}
