//===-- WG14 N3924 siguninstall entrypoint wrapper -----------------*- C++
//-*-===//
//
...
extern "C"
{
  ...
  int wg14_signals_siguninstall(void *i);
}

namespace LIBC_NAMESPACE_DECL
{

  LLVM_LIBC_FUNCTION(int, siguninstall, (void *i))
  {
    return wg14_signals_siguninstall(i);
  }
