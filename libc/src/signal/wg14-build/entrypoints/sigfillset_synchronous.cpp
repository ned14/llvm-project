//===-- WG14 N3924 sigfillset_synchronous entrypoint wrapper -----------------*-
// C++ -*-===//
//
...
#include "src/signal/sigfillset_synchronous.h"
...
extern "C"
{
  ...
  int wg14_signals_sigfillset_synchronous(sigset_t *set);
}

namespace LIBC_NAMESPACE_DECL
{

  LLVM_LIBC_FUNCTION(int, sigfillset_synchronous, (sigset_t * set))
  {
    return wg14_signals_sigfillset_synchronous(set);
  }
