...
///
/// \file
/// Internal header for the WG14 N3924 signal_decider_destroy entrypoint
/// (implemented by the wg14_signals reference implementation submodule,
/// libc/src/signal/wg14).
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIBC_SRC_SIGNAL_SIGNAL_DECIDER_DESTROY_H
#define LLVM_LIBC_SRC_SIGNAL_SIGNAL_DECIDER_DESTROY_H
...
#endif // LLVM_LIBC_SRC_SIGNAL_SIGNAL_DECIDER_DESTROY_H
