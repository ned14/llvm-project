...
///
/// \file
/// Internal header for the WG14 N3924 tss_async_signal_safe_get entrypoint
/// (implemented by the wg14_signals reference implementation submodule,
/// libc/src/signal/wg14).
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIBC_SRC_SIGNAL_TSS_ASYNC_SIGNAL_SAFE_GET_H
#define LLVM_LIBC_SRC_SIGNAL_TSS_ASYNC_SIGNAL_SAFE_GET_H
...
#endif // LLVM_LIBC_SRC_SIGNAL_TSS_ASYNC_SIGNAL_SAFE_GET_H
